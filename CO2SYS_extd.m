...
if any(F)
	...
	% Sigma of residuals between fits and above data: ÃÂÃÂ±0.015, +0.040 for K1 and K2, respectively.
...
if any(F)
	...
	% Marine and Freshwater Research, v. 61, p. 139ÃÂ¢ÃÂÃÂ142.
...
if any(F)
	...
	% Mar. Chem., 165, 66-67, 2014
        % Corrigendum to ÃÂ¢ÃÂÃÂThe free proton concentration scale for seawater pHÃÂ¢ÃÂÃÂ.
