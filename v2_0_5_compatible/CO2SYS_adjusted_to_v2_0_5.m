function [DATA,HEADERS,NICEHEADERS]=CO2SYS_adjusted_to_v2_0_5(PAR1,PAR2,PAR1TYPE,PAR2TYPE,SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,SI,PO4,NH4,H2S,pHSCALEIN,K1K2CONSTANTS,KSO4CONSTANT,KFCONSTANT,BORON)
%**************************************************************************
%
% Current: CO2SYS_adjusted_to_v2_0_5.m v3.1.1   (Apr  2021: https://github.com/jonathansharp/CO2-System-Extd)
...
%
%  **** SYNTAX:
%  [RESULT,HEADERS,NICEHEADERS]=CO2SYS_adjusted_to_v2_0_5(PAR1,PAR2,PAR1TYPE,PAR2TYPE,...
%        ...SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,SI,PO4,NH4,H2S,pHSCALEIN,...
%        ...K1K2CONSTANTS,KSO4CONSTANT,KFCONSTANT,BORON)
% 
%  **** SYNTAX EXAMPLES:
%  [Result]                     = CO2SYS_adjusted_to_v2_0_5(2400,2200,1,2,35,0,25,4200,0,15,1,0,0,1,4,1,1,1)
%  [Result,Headers]             = CO2SYS_adjusted_to_v2_0_5(2400,   8,1,3,35,0,25,4200,0,15,1,0,0,1,4,1,1,1)
%  [Result,Headers,Niceheaders] = CO2SYS_adjusted_to_v2_0_5( 500,   8,5,3,35,0,25,4200,0,15,1,0,0,1,4,1,1,1)
%  [A]                          = CO2SYS_adjusted_to_v2_0_5(2400,2000:10:2400,1,2,35,0,25,4200,0,15,1,0,0,1,4,1,1,1)
%  [A]                          = CO2SYS_adjusted_to_v2_0_5(2400,2200,1,2,0:1:35,0,25,4200,0,15,1,0,0,1,4,1,1,1)
%  [A]                          = CO2SYS_adjusted_to_v2_0_5(2400,2200,1,2,35,0,25,0:100:4200,0,15,1,0,0,1,4,1,1,1)
%  
%  **** APPLICATION EXAMPLE (copy and paste this into command window):
%  tmps=0:40; sals=0:40; [X,Y]=meshgrid(tmps,sals);
%  A = CO2SYS_adjusted_to_v2_0_5(2300,2100,1,2,Y(:),X(:),nan,0,nan,1,1,0,0,1,9,1,1,1);
...
%    A = CO2SYS_adjusted_to_v2_0_5(2400,2200,1,2,35,25,1,0,4200,1,1,0,0,1,4,1,1,1)
%    pH_lab = A(3);  % 7.8429
%    pH_sea = A(20); % 8.0503
% 
%**************************************************************************
...
Revelle = (fCO2plus - fCO2minus)./dTC./((fCO2plus + fCO2minus)./TCi); % There is an error here, perturbed TC is used in this calculation rather than initial TC
varargout{1}=Revelle;
end % end nested function
