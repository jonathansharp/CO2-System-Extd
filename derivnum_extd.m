...
function [derivatives, headers, units, headers_err, units_err] = ...
    ...
    SI1 = SI; SI2 = SI;
    PO41  = PO4; PO42  = PO4;
    % no change on Amm total and H2S total
    NH41  = NH4; NH42 = NH4;
    H2S1  = H2S; H2S2  = H2S;
            ...
            delta = 1.e-6;
             ...
             switch PAR1TYPE(1)
                ...
                case 5
                  ...
                  units = units_pco2;
                  PAR1ref = 400.; % uatm
                case 6 % Added by J. Sharp for HCO3
                  denom_headers = 'HCO3';
                  denom_units = 'umol';
                  units = units_at;
                  PAR1ref = 1790.; % umol/kg
                case 7 % Added by J. Sharp for CO3
                  denom_headers = 'CO3';
                  denom_units = 'umol';
                  units = units_at;
                  PAR1ref = 200.; % umol/kg
                case 8 % Added by J. Sharp for CO2
                  denom_headers = 'CO2';
                  denom_units = 'umol';
                  units = units_at;
                  PAR1ref = 10.; % umol/kg
    ...
    %    19 - OmegaAr input        ()
    %    20 - xCO2 input           (ppm)
    %    21 - [H+] output          (nmol/kgSW)  lastly added
    %    23 - pCO2 output          (uatm)
    %    24 - fCO2 output          (uatm)
    %    25 - HCO3 output          (umol/kgSW)
    %    26 - CO3 output           (umol/kgSW)
    %    27 - CO2 output           (umol/kgSW)
    %    36 - OmegaCa output       ()
    %    37 - OmegaAr output       ()
    %    38 - xCO2 output          (ppm)
